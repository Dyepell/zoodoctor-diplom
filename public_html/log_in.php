...
<div class="row container-fluid" style='height:20%;'></div>
  ...
  <legend style = 'color:#656565;font-size:200%;'>Вход</legend>
        <div class="polya">

            <div class="row">
            <div class="col-3">
            <label for="login" style='margin-top:10px;font-size:120%; width:100%; text-align:left;'>Логин:</label><br>
            ...
            <input style='margin-top:10px;' type="password" class="form-control"  placeholder="******"name="password" >
            </div>
            </div>
            
          <div class='row'style='margin-top:10px;'>
          <div class="col-4"></div>
          <div class="col-4"><button type="submit" class="btn-block btn btn-primary vhod"  name="log">Войти</button></div>
          <div class="col-4"></div>
            </div>
