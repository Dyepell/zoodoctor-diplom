...
<div class="row container-fluid" style='height:20%;'></div>
  <div class="row-offset container-fluid" >
  <div class="col-sm-3"></div>
  <div class="col-sm-6" class='log_form' style='background-color:#8de6e6; padding:10px;text-align:center;   color: #656565;'>
  <form action="reg.php" method="POST">
      <legend style = 'color:#656565;font-size:200%;'>Регистрация</legend>
        <div class="polya">

            <div class="row">
            <div class="col-3">
            <label for="mail" style='margin-top:10px;font-size:120%;width:100%; text-align:left;' >E-mail</label>
            <label for="login" style='margin-top:10px;font-size:120%; width:100%; text-align:left;'>Логин</label>
            <label for="name" style='margin-top:10px;font-size:120%; width:100%; text-align:left;'>Имя </label>
            <label for="lastname" style='margin-top:10px;font-size:120%;width:100%; text-align:left;'>Фамилия</label>
            <label for="phone" style='margin-top:10px;font-size:120%;width:100%; text-align:left;'>Телефон</label>
            <label for="password" style='margin-top:10px;font-size:120%;width:100%; text-align:left;'>Пароль</label>
            
            </div> 
            <div class="col-9">
            <input  type="text " class="form-control"  name="mail" placeholder="qwerty@mail.ru">
            <input  style='margin-top:5px;'type="text " class="form-control"  name="login" placeholder="Введите логин" >

            <input  style='margin-top:5px;'type="text " class="form-control"  name="name1" placeholder="Введите имя">
            <input  style='margin-top:5px;'type="tel " class="form-control"  name="lastname"placeholder="Введите фамилию">
            <input id="phone" style='margin-top:5px;'type="text " class="form-control"  name="phone"placeholder="+7(xxx)xxx-xx-xx">
            <input style='margin-top:5px;' type="password" class="form-control"  name="password" placeholder="******">
          ...
          <div class="col-3 "></div>
          <div class="col-6 "><button type="submit" class="btn-block btn btn-primary vhod"   name="reg">Регистрация</button></div>
          <div class="col-3"></div>
            </div>
